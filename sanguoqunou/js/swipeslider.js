  ...
  $.fn.swipeslider = function (options) {
    ...
    */
    (function init() {
      ...
      // Jump to slide management (since another slide was added to the beginning of row);
      jumpToSlide(1);
    ...
    */
    function swipeStart(event) {
      ...
      if (slidingState == 0){
        slidingState = 1; // Status management = slide started.
    ...
    function swiping(event) {
      ...
      if (slidingState == 2) {
        ...
        if ((currentSlide == 0 && pointerData.clientX > startClientX) ||
          ...
          // Set ratio to 3 means image will be moving by 3 pixels each time user moves it's pointer by management pixel. (Rubber-band effect)
          touchPixelRatio = 3;
        }
