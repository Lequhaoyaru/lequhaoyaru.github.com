let areaList = [
  {
    ...
    "city": [
      {
        "name": "北京市",
        "area": ["东城区", "西城区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "平谷区", "怀柔区", "密云区", "延庆区"]
      }
    ],
    "json": "beijing"
  },
  {
    ...
    "city": [
      {
        "name": "天津市",
        "area": ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "宁河区", "静海区", "蓟州区","滨海新区"]
      }
      ],
    "json": "tianjin"
  },
  {
    ...
    "city": [
      {
        "name": "石家庄市",
        "area": ["长安区", "裕华区", "桥西区", "新华区", "井陉矿区", "井陉县", "正定区", "栾城区", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县", "辛集市", "藁城区", "晋州市", "新乐市", "鹿泉区"]
      },
      {
        "name": "唐山市",
        "area": ["曹妃甸区","丰南区","丰润区","古冶区","开平区","乐亭县","芦台区","路北区","路南区","滦南县","滦州市","迁安市","迁西县","玉田县","遵化市"]
      },
      {
        "name": "秦皇岛市",
        "area": ["海港区", "山海关区", "北戴河区", "青龙满族自治县", "昌黎县", "抚宁区", "卢龙县"]},
      {
        "name": "邯郸市",
        "area": ["邯山区", "复兴区", "峰峰矿区", "邯郸县", "临漳县", "成安县", "大名县", "涉县", "磁县", "肥乡区", "永年区", "邱县", "鸡泽县", "广平县", "馆陶县", "魏县", "曲周县", "武安市"]
      },
      {
        "name": "邢台市",
      ...
      {
        "name": "保定市",
        "area": ["满城区", "清苑区", "涞水县", "阜平县", "徐水县", "定兴县", "唐县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县", "涿州市", "定州市", "安国市", "高碑店市","竞秀区","莲池区"]
      },
      {
        "name": "张家口市",
        "area": ["桥东区", "桥西区", "宣化区", "下花园区", "宣化县", "张北县", "康保县", "沽源县", "尚义县", "蔚县", "阳原县", "怀安县", "万全区", "怀来县", "涿鹿县", "赤城县", "崇礼区"]
      },
      {
        "name": "承德市",
        "area": ["双桥区", "双滦区", "鹰手营子矿区", "承德县", "兴隆县", "平泉市", "滦平县", "隆化县", "丰宁满族自治县", "宽城满族自治县", "围场满族蒙古族自治县"]
      },
      {
        "name": "沧州市",
      ...
      {
        "name": "廊坊市",
        "area": ["安次区", "固安县", "永清县", "香河县", "大城县", "文安县", "大厂回族自治县", "霸州市", "三河市","广阳区"]
      },
      {
        "name": "衡水市",
        "area": ["桃城区", "枣强县", "武邑县", "武强县", "饶阳县", "安平县", "故城县", "景县", "阜城县", "冀州区", "深州市"]
      }
    ],
    "json": "hebei"
  },
  {
    ...
    "city": [
      ...
      {
        "name": "大同市",
        "area": ["平城区", "云冈区","云州区", "新荣区", "阳高县", "天镇县", "广灵县", "灵丘县", "浑源县", "左云县"]
      },
      {
        "name": "阳泉市",
      ...
      {
        "name": "长治市",
        "area": ["襄垣县", "屯留区", "平顺县", "黎城县", "壶关县", "长子县", "武乡县", "沁县", "沁源县", "潞城区","潞州区","上党区"]
      },
      {
        "name": "晋城市",
      ...
      {
        "name": "临汾市",
        "area": ["侯马市", "霍州市", "曲沃县", "翼城县", "襄汾县", "洪洞县", "古县", "安泽县", "浮山县", "吉县", "乡宁县", "蒲县", "大宁县", "永和县", "隰县", "汾西县","尧都区"]
      },
      {
        "name": "运城市",
          "area": ["永济市", "河津市", "芮城县", "临猗县", "万荣县", "新绛县", "稷山县", "闻喜县", "夏县", "绛县", "平陆县", "垣曲县","盐湖区"]
      }
    ],
    "json": "shanxi"
  },
  {
    ...
    "city": [
      {
        "name": "呼和浩特市",
        "area": ["新城区", "回民区", "玉泉区", "土默特左旗", "托克托县", "和林格尔县", "清水河县", "武川县","赛罕区"]
      },
      {
        "name": "包头市",
        "area": ["东河区", "昆都伦区", "青山区", "石拐区", "白云鄂博矿区", "土默特右旗", "固阳县", "达尔罕茂明安联合旗","九原区"]
      },
      {
        "name": "乌海市",
        "area": ["海勃湾区", "海南区", "乌达区"]
      ...
      {
        "name": "呼伦贝尔市",
        "area": ["海拉尔市", "满洲里市", "扎兰屯市", "牙克石市", "根河市", "额尔古纳市", "阿荣旗", "莫力达瓦达斡尔族自治旗", "鄂伦春自治旗", "鄂温克族自治旗", "新巴尔虎右旗", "新巴尔虎左旗", "陈巴尔虎旗","扎赉诺尔区"]
      },
      {
        "name": "兴安盟",
      ...
      {
        "name": "鄂尔多斯市",
        "area": ["东胜区", "达拉特旗", "准格尔旗", "鄂托克前旗", "鄂托克旗", "杭锦旗", "乌审旗", "伊金霍洛旗","康巴什区"]
      },
      {
        "name": "巴彦淖尔市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "沈阳市",
        "area": ["沈河区", "皇姑区", "和平区", "大东区", "铁西区", "苏家屯区", "浑南区", "于洪区", "新民市", "法库县", "辽中区", "康平县", "沈北新区"]
      },
      {
        "name": "大连市",
        "area": ["西岗区", "中山区", "沙河口区", "甘井子区", "旅顺口区", "金州区", "瓦房店市", "普兰店区", "庄河市", "长海县", "其他"]
      },
      {
        "name": "鞍山市",
      ...
      {
        "name": "锦州市",
        "area": ["北镇市","太和区", "古塔区", "凌河区", "凌海市", "黑山县", "义县","其他"]
      },
      {
        "name": "营口市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "长春市",
        "area": ["朝阳区", "宽城区", "二道区", "南关区", "绿园区", "双阳区", "九台区", "榆树市", "德惠市", "农安县"]
      },
      {
        "name": "吉林市",
      ...
      {
        "name": "白山市",
        "area": ["浑江区", "江源区", "临江市", "靖宇县", "抚松县", "长白朝鲜族自治县"]
      },
      {
        "name": "松原市",
        "area": ["宁江区", "乾安县", "长岭县", "扶余市", "前郭尔罗斯蒙古族自治县"]
      },
      {
        "name": "白城市",
  ...
  },
  {
    ...
    "city": [
      ...
      {
        "name": "牡丹江市",
        "area": ["爱民区", "东安区", "阳明区", "西安区", "绥芬河市", "宁安市", "海林市", "穆棱市", "林口县", "东宁市"]
      },
      {
        "name": "佳木斯市",
        "area": ["向阳区", "前进区", "东风区", "郊区", "同江市", "富锦市", "桦川县", "抚远市", "桦南县", "汤原县"]
      },
      {
        "name": "七台河市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "上海市",
        "area": ["黄浦区", "徐汇区", "长宁区", "静安区", "普陀区", "虹口区", "杨浦区", "宝山区", "闵行区", "嘉定区", "松江区", "金山区", "青浦区", "奉贤区", "浦东新区", "崇明区"]
      }
    ],
    "json": "shanghai"
  },
  {
    ...
    "city": [
      {
        "name": "南京市",
        "area": ["玄武区", "秦淮区", "建邺区", "鼓楼区", "栖霞区", "雨花台区", "浦口区", "江宁区", "六合区", "溧水区", "高淳区"]
      },
      {
        "name": "苏州市",
      ...
      {
        "name": "无锡市",
        "area": [ "滨湖区", "锡山区", "惠山区", "江阴市", "宜兴市","梁溪区","新吴区"]
      },
      {
        "name": "常州市",
        "area": ["钟楼区", "天宁区", "新北区", "武进区", "金坛区", "溧阳市"]
      },
      {
        "name": "镇江市",
      ...
      {
        "name": "南通市",
        "area": ["崇川区", "港闸区", "通州区", "如皋市", "海门市", "启东市", "海安市", "如东县"]
      },
      {
        "name": "泰州市",
        "area": ["海陵区", "高港区", "姜堰区", "泰兴市", "靖江市", "兴化市"]
      },
      {
        "name": "扬州市",
        "area": ["广陵区", "邗江区", "江都区", "仪征市", "高邮市", "宝应县"]
      },
      {
        "name": "盐城市",
        "area": ["亭湖区", "盐都区", "大丰区", "东台市", "建湖县", "射阳县", "阜宁县", "滨海县", "响水县"]
      },
      {
        "name": "连云港市",
        "area": ["海州区", "连云区", "东海县", "灌云县", "赣榆区", "灌南县"]
      },
      {
        "name": "徐州市",
        "area": ["云龙区", "鼓楼区", "泉山区", "贾汪区", "邳州市", "新沂市", "铜山区", "睢宁县", "沛县", "丰县"]
      },
      {
        "name": "淮安市",
        "area": [ "清江浦区","淮阴区", "涟水县", "洪泽区", "金湖县", "盱眙县","淮安区"]
      },
      {
        "name": "宿迁市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "杭州市",
        "area": ["拱墅区", "西湖区", "上城区", "下城区", "江干区", "滨江区", "余杭区", "萧山区", "建德市", "富阳区", "临安区", "桐庐县", "淳安县"]
      },
      {
        "name": "宁波市",
        "area": ["海曙区", "江北区", "镇海区", "北仑区", "鄞州区", "余姚市", "慈溪市", "奉化区", "宁海县", "象山县"]
      },
      {
        "name": "温州市",
        "area": ["鹿城区", "龙湾区", "瓯海区", "瑞安市", "乐清市", "永嘉县", "洞头区", "平阳县", "苍南县", "文成县", "泰顺县"]
      },
      {
        "name": "嘉兴市",
        "area": [ "秀洲区", "海宁市", "平湖市", "桐乡市", "嘉善县", "海盐县","南湖区"]
      },
      {
        "name": "湖州市",
      ...
      {
        "name": "台州市",
        "area": ["椒江区", "黄岩区", "路桥区", "临海市", "温岭市", "玉环市", "天台县", "仙居县", "三门县"]
      },
      {
        "name": "丽水市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "合肥市",
        "area": ["庐阳区", "瑶海区", "蜀山区", "包河区", "长丰县", "肥东县", "肥西县","巢湖市","庐江县"]
      },
      {
        "name": "芜湖市",
        "area": ["镜湖区", "弋江区", "鸠江区", "三山区", "芜湖县", "南陵县", "繁昌县","无为县"]
      },
      {
        "name": "蚌埠市",
      ...
      {
        "name": "淮南市",
        "area": ["田家庵区", "大通区", "谢家集区", "八公山区", "潘集区", "凤台县","寿县"]
      },
      {
        "name": "马鞍山市",
        "area": ["雨山区", "花山区", "金家庄区", "当涂县","博望区","含山县","和县"]
      },
      {
        "name": "淮北市",
      ...
      {
        "name": "铜陵市",
        "area": ["铜官山区", "狮子山区", "郊区", "义安区","枞阳县"]
      },
      {
        "name": "安庆市",
        "area": ["迎江区", "大观区", "宜秀区", "桐城市", "宿松县", "太湖县", "怀宁县", "岳西县", "望江县", "潜山市"]
      },
      {
        "name": "黄山市",
      ...
      {
        "name": "六安市",
        "area": ["金安区", "裕安区", "霍山县", "霍邱县", "舒城县", "金寨县","叶集区"]
      },
      {
        "name": "亳州市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "福州市",
        "area": ["鼓楼区", "台江区", "仓山区", "马尾区", "晋安区", "福清市", "长乐区", "闽侯县", "闽清县", "永泰县", "连江县", "罗源县", "平潭县"]
      },
      {
        "name": "厦门市",
      ...
      {
        "name": "南平市",
        "area": ["延平区", "建瓯市", "邵武市", "武夷山市", "建阳区", "松溪县", "光泽县", "顺昌县", "浦城县", "政和县"]
      },
      {
        "name": "龙岩市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "南昌市",
        "area": ["东湖区", "西湖区", "青云谱区", "湾里区", "青山湖区", "新建区", "南昌县", "进贤县", "安义县"]
      },
      {
        "name": "景德镇市",
      ...
      {
        "name": "九江市",
        "area": [ "柴桑区" , "浔阳区", "庐山区", "瑞昌市", "武宁县", "彭泽县", "永修县", "修水县", "湖口县", "德安县", "都昌县", "共青城市" ,"濂溪区"]
      },
      {
        "name": "新余市",
        "area": ["渝水区", "分宜县"]
      ...
      {
        "name": "赣州市",
        "area": ["章贡区", "瑞金市", "南康区", "石城县", "安远县", "赣县区", "宁都县", "寻乌县", "兴国县", "定南县", "上犹县", "于都县", "龙南县", "崇义县", "信丰县", "全南县", "大余县", "会昌县"]
      },
      {
        "name": "吉安市",
      ...
      {
        "name": "抚州市",
        "area": ["临川区", "南丰县", "乐安县", "金溪县", "南城县", "东乡区", "资溪县", "宜黄县", "广昌县", "黎川县", "崇仁县"]
      },
      {
        "name": "上饶市",
        "area": ["信州区", "德兴市", "上饶县", "广丰区", "鄱阳县", "婺源县", "铅山县", "余干县", "横峰县", "弋阳县", "玉山县", "万年县"]
      }
    ],
    "json": "jiangxi"
  },
  {
    ...
    "city": [
      {
        "name": "济南市",
        "area": ["钢城区", "历下区", "天桥区", "槐荫区", "历城区", "长清区", "章丘区", "平阴县", "济阳区", "商河县","莱芜区","市中区"]
      },
      {
        "name": "青岛市",
        "area": ["市南区", "市北区", "城阳区", "李沧区", "黄岛区", "崂山区", "胶州市", "平度市", "莱西市", "即墨区"]
      },
      {
        "name": "淄博市",
      ...
      {
        "name": "济宁市",
        "area": [ "任城区", "曲阜市", "兖州市", "邹城市", "鱼台县", "金乡县", "嘉祥县", "微山县", "汶上县", "泗水县", "梁山县"]
      },
      {
        "name": "泰安市",
      ...
      {
        "name": "临沂市",
        "area": ["兰山区", "罗庄区", "河东区", "沂南县", "郯城县", "沂水县", "费县", "平邑县", "莒南县", "蒙阴县", "临沭县","兰陵县"]
      },
      {
        "name": "德州市",
        "area": ["德城区", "乐陵市", "禹城市", "陵城区", "宁津县", "齐河县", "武城县", "庆云县", "平原县", "夏津县", "临邑县"]
      },
      {
        "name": "聊城市",
      ...
      {
        "name": "滨州市",
        "area": ["滨城区", "邹平市", "沾化区", "惠民县", "博兴县", "阳信县", "无棣县"]
      },
      {
        "name": "菏泽市",
        "area": ["牡丹区", "鄄城县", "单县", "郓城县", "曹县", "定陶区", "巨野县", "东明县", "成武县"]
      }
    ],
    "json": "shandong"
  },
  {
    ...
    "city": [
      ...
      {
        "name": "开封市",
        "area": ["鼓楼区", "龙亭区", "顺河回族区", "禹王台区", "尉氏县", "兰考县", "杞县", "通许县","祥符区"]
      },
      {
        "name": "洛阳市",
      ...
      {
        "name": "焦作市",
        "area": ["博爱县","解放区","马村区","孟州市","沁阳市","山阳区","温县","武陂县","中站区","修武县"]
      }
    ],
    "json": "henan"
  },
  {
    ...
    "city": [
      ...
      {
        "name": "十堰市",
        "area": ["张湾区", "茅箭区", "丹江口市", "郧阳区", "竹山县", "房县", "郧西县", "竹溪县"]
      },
      {
        "name": "荆州市",
      ...
      {
        "name": "襄阳市",
        "area": ["襄城区", "樊城区", "襄州区", "老河口市", "枣阳市", "宜城市", "南漳县", "谷城县", "保康县"]
      },
      {
        "name": "鄂州市",
        "area": ["鄂城区", "华容区", "梁子湖区"]
  ...
  },
  {
    ...
    "city": [
      {
        "name": "长沙市",
        "area": ["岳麓区", "芙蓉区", "天心区", "开福区", "雨花区", "浏阳市", "长沙县", "望城区", "宁乡县"]
      },
      {
        "name": "株洲市",
        "area": ["天元区", "荷塘区", "芦淞区", "石峰区", "醴陵市", "渌口区", "炎陵县", "茶陵县", "攸县"]
      },
      {
        "name": "湘潭市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "广州市",
        "area": ["越秀区", "荔湾区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "花都区", "南沙区", "增城区", "从化区"]
      },
      {
        "name": "深圳市",
        "area": ["福田区", "罗湖区", "南山区", "宝安区", "龙岗区", "盐田区","光明区","龙华区","坪山区"]
      },
      {
        "name": "东莞市",
        "area": []
      ...
      {
        "name": "茂名市",
        "area": ["茂南区", "信宜市", "化州市", "信宜市", "高州市", "电白区"]
      },
      {
        "name": "肇庆市",
        "area": ["端州区", "鼎湖区", "高要区", "四会市", "广宁县", "怀集县", "封开县", "德庆县"]
      },
      {
        "name": "惠州市",
      ...
      {
        "name": "梅州市",
        "area": ["梅江区", "兴宁市", "梅县区", "大埔县", "丰顺县", "五华县", "平远县", "蕉岭县"]
      },
      {
        "name": "汕尾市",
        "area": ["城区", "陆丰市", "海丰县", "陆河县"]
      ...
      {
        "name": "阳江市",
        "area": ["江城区", "阳春市", "阳西县", "阳东区"]
      },
      {
        "name": "清远市",
        "area": ["清城区","清新区", "英德市", "连州市", "佛冈县", "阳山县", "连山壮族瑶族自治县", "连南瑶族自治县"]
      }
    ],
    "json": "guangdong"
  },
  {
    ...
    "city": [
      {
        "name": "南宁市",
        "area": ["青秀区", "兴宁区", "西乡塘区", "良庆区", "江南区", "邕宁区", "武鸣区", "隆安县", "马山县", "上林县", "宾阳县", "横县"]
      },
      {
        "name": "柳州市",
        "area": ["城中区", "鱼峰区", "柳北区", "柳南区", "柳江区", "柳城县", "鹿寨县", "融安县", "融水苗族自治县", "三江侗族自治县"]
      },
      {
        "name": "桂林市",
        "area": ["象山区", "秀峰区", "叠彩区", "七星区", "雁山区", "阳朔县", "临桂区", "灵川县", "全州县", "平乐县", "兴安县", "灌阳县", "荔浦县", "资源县", "永福县", "龙胜各族自治县", "恭城瑶族自治县"]
      },
      {
        "name": "梧州市",
        "area": ["万秀区", "长洲区", "岑溪市", "苍梧县", "藤县", "蒙山县","龙圩区"]
      },
      {
        "name": "北海市",
      ...
      {
        "name": "玉林市",
        "area": ["玉州区", "北流市", "容县", "陆川县", "博白县", "兴业县","福绵区"]
      },
      {
        "name": "百色市",
        "area": ["右江区", "凌云县", "平果县", "西林县", "乐业县", "德保县", "田林县", "田阳县", "靖西市", "田东县", "那坡县", "隆林各族自治县"]
      },
      {
        "name": "贺州市",
        "area": ["八步区", "钟山县", "昭平县", "富川瑶族自治县","平桂区"]
      },
      {
        "name": "河池市",
        "area": ["金城江区", "宜州区", "天峨县", "凤山县", "南丹县", "东兰县", "都安瑶族自治县", "罗城仫佬族自治县", "巴马瑶族自治县", "环江毛南族自治县", "大化瑶族自治县"]
      },
      {
        "name": "来宾市",
  ...
  },
  {
    ...
    "city": [
      {
        "name": "重庆市",
        "area": ["渝中区", "大渡口区", "江北区", "南岸区", "北碚区", "渝北区", "巴南区", "长寿区", "双桥区", "沙坪坝区", "万盛区", "万州区", "涪陵区", "黔江区", "永川区", "合川区", "江津区", "九龙坡区", "南川区", "綦江县", "潼南县", "荣昌县", "璧山县", "大足区", "铜梁县", "梁平县", "开县", "忠县", "城口县", "垫江县", "武隆县", "丰都县", "奉节县", "云阳县", "巫溪县", "巫山县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县"]
      }
    ],
    "json": "chongqing"
